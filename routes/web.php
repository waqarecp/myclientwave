...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/subscription/cancel/{plan?}', [SubscriptionController::class, 'cancelSubscription'])->name('subscription.cancel');
    Route::get('/subscription/resume/{plan?}', [SubscriptionController::class, 'resumeSubscription'])->name('subscription.resume');
    Route::get('/checkout/{plan?}', CheckoutController::class)->name('subscription.StripeCheckout');
    ...
    Route::middleware(['auth', 'subscribed'])->group(function () {
        ...
        Route::post('/appointments/react-to-comment', [AppointmentController::class, 'reactToComment'])->name('appointments.reactToComment');
        Route::post('/appointments/note-store', [AppointmentController::class, 'noteStore'])->name('appointments.noteStore');
        Route::post('/appointments/view-comments', [AppointmentController::class, 'viewComments'])->name('appointments.viewComments');
