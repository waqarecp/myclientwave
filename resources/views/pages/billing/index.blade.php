                    ...
                    <div class="col-xl-4">
                        <div class="d-flex h-100 align-items-center">
                            ...
                            <div class="w-100 d-flex flex-column flex-center rounded-3 bg-light bg-opacity-75 py-15 px-10">
                                ...
                                <!--end::Heading-->
                                <!--begin::Select-->
                                <a href="{{ route('subscription.StripeCheckout', ['plan' => 'price_1Q45NrKb9baEyQNdgQaW4qUW']) }}" class="btn btn-sm btn-primary">Select</a>
                                <!--end::Select-->
                            </div>
                            <!--end::Option-->
                        </div>
                    ...
                    <div class="col-xl-4">
                        <div class="d-flex h-100 align-items-center">
                            ...
                            <div class="w-100 d-flex flex-column flex-center rounded-3 bg-light bg-opacity-75 py-20 px-10">
                                ...
                                <!--end::Heading-->
                                <!--begin::Select-->
                                <a href="{{ route('subscription.StripeCheckout', ['plan' => 'price_1Q45OsKb9baEyQNdfvPaB3ma']) }}" class="btn btn-sm btn-primary">Select</a>
                                <!--end::Select-->
                            </div>
                            <!--end::Option-->
                        </div>
                    ...
                    <div class="col-xl-4">
                        <div class="d-flex h-100 align-items-center">
                            ...
                            <div class="w-100 d-flex flex-column flex-center rounded-3 bg-light bg-opacity-75 py-15 px-10">
                                ...
                                <!--end::Heading-->
                                <!--begin::Select-->
                                <a href="{{ route('subscription.StripeCheckout', ['plan' => 'price_1Q45PKKb9baEyQNdi5ppTVTT']) }}" class="btn btn-primary">Select</a> 
                                <!--end::Select-->
                            </div>
                            <!--end::Option-->
                        </div>
