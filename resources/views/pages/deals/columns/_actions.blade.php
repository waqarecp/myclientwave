...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-stage-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
    ...
    <!--begin::Menu item-->
        <div class="menu-item px-3">
            <a href="javascript:void(0)" class="menu-link px-3" data-kt-deal-id="{{ $deal->deal_id }}"
                data-kt-deal-name="{{ $deal->deal_name }}"  onclick="update_deal_modal(this)">
                Edit
            </a>
        </div>
    @endif
    ...
    <!--begin::Menu item-->
    <div class="menu-item px-3">
        <a href="#" class="menu-link px-3" data-kt-deal-id="{{ $deal->deal_id }}" data-kt-action="delete_row">
            Delete
        </a>
    </div>
    @endif
