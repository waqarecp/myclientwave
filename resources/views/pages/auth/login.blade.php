    ...
    <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="{{ route('dashboard') }}" action="{{ route('login') }}">
        ...
        <div class="text-center mb-11">
            ...
            <h1 class="text-gray-900 fw-bolder mb-3">
                Sign In To MyClientWave Dashboard
            </h1>
            <!--end::Title-->

            <!--begin::Subtitle-->
            <div class="text-gray-500 fw-semibold fs-6">
                Unlock Your Business Potential with MyClientWave's Dynamic Dashboard
            </div>
            <!--end::Subtitle--->
        </div>
        <!--begin::Heading-->
        ...
        <div class="separator separator-content my-14">
            <span class="w-400px text-gray-500 fw-semibold fs-7">Enter your email & password</span>
        </div>
        <!--end::Separator-->
