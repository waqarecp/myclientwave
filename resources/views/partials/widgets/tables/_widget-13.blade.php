        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold fs-3 mb-1">Channel Performance</span>
                    <span class="text-muted mt-1 fw-semibold fs-7">{{ $data['dateRange'] }}</span>
                </h3>
            </div>
            <!--end::Header-->
            <!--begin::Body-->
                    ...
                    <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                        ...
                        <thead>
                            <tr class="fw-bold text-muted">
                                ...
                                <th class="min-w-150px">Dimension</th>
                                <th class="min-w-140px">Sessions</th>
                                <th class="min-w-120px">vs 1M ago</th>
                                <th class="min-w-120px">Users</th>
                                <th class="min-w-120px">vs 1M ago</th>
                                <th class="min-w-120px">Views/Session</th>
                                <th class="min-w-120px">vs 1M ago</th>
                                <th class="min-w-120px">Engagement Rate</th>
                                <th class="min-w-120px">vs 1M ago</th>
                                <th class="min-w-120px">Conversions</th>
                        ...
                        <!--begin::Table body-->
                        <tbody>
                            @foreach($data['channelPerformanceData'] as $item)
                            <tr>
                                <td>
